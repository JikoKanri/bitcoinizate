(() => {
  ...
  const dict = {
    ...
    es: {
      ...
      tut9: "Opciones → Gráficos: Clásico es el look original. Otras paletas cambian el tablero. El héroe animado cambia el ₿ por Choppy de las cartas Arc.",
      faq: "Preguntas",
      ...
      hero2d: "2D",
      pickHero: "HÉROE",
      animHeroHint: "Cada estilo tiene un héroe 2D y uno animado. Por defecto se usa el 2D de ese tema.",
