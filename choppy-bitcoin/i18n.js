(() => {
  ...
  const dict = {
    en: {
      ...
      speed: "Speed",
      perks: "Perks",
      grabPerk: "Grab your perk:",
      market: "Marketplace",
      pickOne: "Pick one. Then tap ▶.",
      declinePerk: "Gently decline",
      declinePerkSub: "keep flying, no perk",
    ...
    es: {
      ...
      playNow: "Jugar ahora",
      playSub: "Jugar es ranked (0 cold, 0 multisig).",
      ...
      trainNote: "9 cold y 999 multisig. No cuenta para el ranking ni los premios.",
      tryAgain: "Otra vez",
