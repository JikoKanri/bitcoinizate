(() => {
  ...
  const dict = {
    en: {
      ...
      lead1: "Bitcoinizate is a new games site. This is our first title.",
      ...
      faqPrizeA: "Guest scores do not count. We may ignore runs that look automated.",
      playMoney: "In-game cash, price and score are play money. They are not real bitcoin.",
      how: "How to play",
      enjoy: "We hope you try and enjoy our first game.",
      prizes: "September 2026 prizes, paid in satoshis to a bitcoin address saved on your profile: 5,000 first, 3,000 second, 2,000 third.",
      feedback: "Feedback",
      send: "Send",
      thanks: "Thanks.",
      ...
      faqWhatA: "A site of free bitcoin-themed games. One game now: Choppy Bitcoin. No token. In the browser.",
      ...
      play: "Play",
      trainCamp: "Training camp",
      trainNote: "Play is ranked (0 cold, 0 multisig). Training camp is 9 cold and 999 multisig and does not count for the board or awards.",
      tryAgain: "Try again",
    ...
    es: {
      ...
      lead1: "Bitcoinizate es un sitio nuevo de juegos. Este es nuestro primer título.",
      ...
      faqPrizeA: "El puntaje de invitado no cuenta. Podemos descartar partidas que parezcan automáticas.",
      playMoney: "El efectivo, el precio y el puntaje del juego son play money. No es bitcoin real.",
      how: "Cómo se juega",
      enjoy: "Esperamos que pruebes y disfrutes nuestro primer juego.",
      prizes: "Premios septiembre 2026, en satoshis a una dirección bitcoin guardada en el perfil: 5.000 el primero, 3.000 el segundo, 2.000 el tercero.",
      feedback: "Feedback",
      send: "Enviar",
      thanks: "Gracias.",
      tut1: "Eres el ₿. Toca o aprieta espacio para pasar por el hueco de las velas. Una mecha te liquida. El piso solo cuenta cuando salís del todo de la pantalla.",
      tut2: "Las velas pagan efectivo. Compra BTC en la baja, vende en la subida. El puntaje es patrimonio de juguete en BTC al precio en vivo del juego.",
      tut3a: "El bull sube el precio.",
      tut3b: "El bear lo tira.",
      tut4a: "El cisne negro es una caída negra fuerte que alarga el bear.",
      tut4b: "El halving es un bull grande. Sale arriba o justo sobre Compra/Vende.",
      ...
      faqWhatA: "Un sitio de juegos gratis de temática bitcoin. Un juego ahora: Choppy Bitcoin. Sin token. En el navegador.",
      ...
      play: "Jugar",
      trainCamp: "Campo de entrenamiento",
      trainNote: "Jugar es ranked (0 cold, 0 multisig). El campo de entrenamiento es 9 cold y 999 multisig y no cuenta para el ranking ni los premios.",
      tryAgain: "Otra vez",
