(() => {
  ...
  const CHANCE_CARDS = [
    { id: "landfill", kind: "choice",
      ...
      bodyEs: "A la 1:14 a. m., Nico envía un mensaje de voz. La foto está oscura: un camión y una pala apoyada en el capó.\n\n\"Estoy en Gales\", dice. \"Me autorizaron a excavar en Docksway. Se supone que allí se perdió una memoria USB con 8,000 BTC en 2009. Quiero un socio, no un espectador.\"\n\nDesde el otro lado de la cama, Lena abre un ojo. \"Si inviertes dinero en una búsqueda del tesoro a la 1:14 a. m., la próxima vez que estés a punto de terminar te llamaré Fartface.\"\n\nMiras la foto otra vez. La pala resulta sorprendentemente convincente.",
      opts: [
    ...
    { id: "taxbill", kind: "report",
      ...
      bodyEs: "Llega tu factura trimestral de impuestos. La abres, la observas, la cierras y vuelves a abrirla, como si el monto pudiera haber cambiado. No cambió." },
