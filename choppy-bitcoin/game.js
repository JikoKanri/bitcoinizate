...
,
  ...
  const BC_ART=Object.fromEntries(["justInCase","nothingToHide","somethingBetter","timeTraveler","temporaryMeasures","citadelProblem","declaration","theAnswer","fourthColor","notYet"].map(x=>[x,1]));
