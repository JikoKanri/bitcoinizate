...
function gameOver() {
    ...
    if (menuText) {
        menuText.innerHTML = "REKT!<br><br><span style='color:#FFF; font-size:0.9rem;'>LIQUIDATED</span><br><br>LEFT CASH: $" + walletUSD.toFixed(2) + " USD<br>FINAL HOLD: " + walletBTC.toFixed(8) + " BTC";
    }
