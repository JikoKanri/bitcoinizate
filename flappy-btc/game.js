...
let walletBTC = 0.00000000;   // ¡ESTA VARIABLE DICTA EL HIGH SCORE!
...
let chartOffset = 0;
// GAME.JS - PARTE 2 DE 3: TRADING ENGINE, COMPRA/VENTA Y LOGÍCA DE DERROTA
function resetGame() {
    btc.y = 250;
    btc.velocity = 0;
    pipes = [];
...
function startGame() {
    // Si no inició sesión, el botón verde abre el formulario de registro
    if (!currentUser) {
...
function gameOver() {
    ...
    // --- REGLA MAXIMALISTA CRÍTICA: EL CONTADOR CLOUD RECIBE SOLO TU WALLET EN BTC ---
...
// GAME.JS - PARTE 3 DE 3: COLISIONES LOGÍSTICAS, PUNTO DE INFLEXIÓN Y CANVAS
function update() {
    if (gameState === "PLAYING") {
