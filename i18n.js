(() => {
  ...
  const dict = {
    en: {
      ...
      lead1: "Bitcoinizate is a new games site. These are our titles.",
      ...
      how: "How to play",
      enjoy: "We hope you try them and enjoy the ride.",
      madcapLead: "Roll a world board, buy shops in bitcoin cities, plant traps, and dump Dr. Drago on whoever is last. Richest stack wins.",
      playMadcap: "Play Madcap Hash",
      ...
      faqWhatA: "A site of free bitcoin-themed games. Now: Choppy Bitcoin and Madcap Hash. No token. In the browser.",
      ...
      mpReady: "I'M READY",
      mpUnready: "NOT READY",
      mpNeedReady: "Everyone must be ready",
    ...
    es: {
      ...
      lead1: "Bitcoinizate es un sitio nuevo de juegos. Estos son nuestros títulos.",
      ...
      how: "Cómo se juega",
      enjoy: "Esperamos que los pruebes y disfrutes el viaje.",
      madcapLead: "Recorré un tablero mundial, comprá negocios en ciudades bitcoin, plantá trampas y pasale Dr. Drago al último. Gana el stack más gordo.",
      playMadcap: "Jugar Madcap Hash",
      ...
      faqWhatA: "Un sitio de juegos gratis de temática bitcoin. Ahora: Choppy Bitcoin y Madcap Hash. Sin token. En el navegador.",
      ...
      mpReady: "ESTOY LISTO",
      mpUnready: "NO LISTO",
      mpNeedReady: "Todos tienen que estar listos",
      mpFull: "Sala llena (8)",
